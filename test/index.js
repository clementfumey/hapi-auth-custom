...
var loadUser = function (username, password, params, callback) {
...
before(function (done) {
    ...
    server.pack.register(require('../'), function (err) {
        ...
        server.auth.strategy('default', 'custom', 'required', { validateFunc: loadUser });
...
it('allow missing username', function (done) {
    ...
    server.pack.register(require('../'), function (err) {
        ...
        server.auth.strategy('default', 'custom', {
            validateFunc: function (username, password, params, callback) { callback(null, true, {}); },
...
it('should ask for credentials if server has one default strategy', function (done) {
    ...
    server.pack.register(require('../'), function (err) {
        ...
        server.auth.strategy('default', 'custom', { validateFunc: loadUser });
        server.route({
            path: '/noauth',
            method: 'GET',
            config: {
...
it('passes non-error err in response', function (done) {
    ...
    server.pack.register(require('../'), function (err) {
        ...
        server.auth.strategy('custom', 'custom', true, {
            validateFunc: function (username, password, params, callback) {
